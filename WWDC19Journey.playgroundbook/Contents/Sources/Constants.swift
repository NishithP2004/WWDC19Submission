...
struct Constants {
  ...
  static let heroScenePath = "Contents/PrivateResources/Lambourghini_Aventador.obj"
  static let wwdcScenePath = "Contents/PrivateResources/wwdc.scn"
  static let carScenePath = "Contents/PrivateResources/Lambourghini_Aventador.obj"
    
  static let focusNodeName = "focus"
  static let cursorNodeName = "cursor"
  static let floorNodeName = "floor"
  
  static let heroNodeName = "car"
  static let wwdcNodeName = "wwdc"
